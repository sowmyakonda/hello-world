        ...
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="item active">
                    ...
                    <div class="container">
                        <div class="carousel-caption">
                            <h1>Welcome to jewellery Store</h1>
                ...
                <div class="item">
                    ...
                    <div class="container">
                        <div class="carousel-caption">
                            <h1>Facts You Should know About jewellery</h1>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <a class="btn btn-default" href="<c:url value="/product/productList?searchCondition=Instrument" />" role="button">
                        <img class="img-circle" src="<c:url value="/resources/images/1.jpg"/>" alt="Instrument Image" width="140" height="140">
                    </a>
                ...
                <div class="col-lg-4">
                    <a class="btn btn-default" href="<c:url value="/product/productList?searchCondition=Record" />" role="button">
                        <img class="img-circle" src="<c:url value="/resources/images/2.jpg"/>" alt="Instrument Image" width="140" height="140">
                    </a>
