    ...
    <div class="container">
        <section>
            <div class="jumbotron">
                <div class="container">
                    <h1>Cart</h1>
                    <p>All the selected products in your shoppingg cart</p>
                </div>
            </div>
        </section>
        ...
        <section class="container" ng-app="cartApp">
            ...
            <div ng-controller = "cartCtrl" ng-init="initCartId('${cartId}')">
                ...
                <div>
                    ...
                    <a href="<spring:url value="/order/${cartId}" />" class="btn btn-success pull-right"><span class="glyphicon glyphicon-shoppingg-cart"></span> Check out</a>
                </div>
